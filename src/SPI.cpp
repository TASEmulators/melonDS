...
void Write(u8 val, u32 hold)
{
    ...
    if (val & 0x80)
    {
        ...
        {
        case 0x10: NDS::AltLagFrameFlag = false; MAYBE_CALLBACK(InputCallback); ConvResult = TouchY; break;
        case 0x50: NDS::AltLagFrameFlag = false; MAYBE_CALLBACK(InputCallback); ConvResult = TouchX; break;
