...
void TSC::Write(u8 val)
{
    ...
    if (val & 0x80)
    {
        ...
        {
        case 0x10: NDS.AltLagFrameFlag = false; ConvResult = TouchY + CreateTouchOffset(DeltaY); break;
        case 0x50: NDS.AltLagFrameFlag = false; ConvResult = TouchX + CreateTouchOffset(DeltaX); break;
